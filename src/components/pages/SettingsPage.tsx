  ...
  return (
    <div className="animate-fade-in">
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 16 }}>
        {[
          {
            title: 'Información del Hospital', icon: 'Building2', color: '#1E88E5',
            fields: [
          ...
          {
            title: 'Estándares & Cumplimiento', icon: 'ShieldCheck', color: '#4CAF50',
            fields: [
          ...
          {
            title: 'Notificaciones & Alertas', icon: 'Bell', color: '#FF9800',
            fields: [
          ...
          {
            title: 'Motor de Scheduling', icon: 'CalendarDays', color: '#9C27B0',
            fields: [
